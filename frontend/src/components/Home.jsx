      ...
      <div className="h-[1250px] md:h-[1050px] text-white container mx-auto">
        ...
        <section className="text-center py-20">
          ...
          <div className="space-x-4 mt-8">
            ...
            <Link
              to={"https://myportfolio01-theta.vercel.app/#contact"}
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="mt-3 ml-2 md:ml-8">
                ...
                <div className="flex space-x-4">
                  <a href="https://github.com/rohansharma99">
                    <FaGithub className="text-2xl hover:text-blue-400 duration-300" />
                  </a>
                  <a href="https://www.instagram.com/_rohansharma_9">
                    <FaInstagram className="text-2xl hover:text-pink-600 duration-300"  />
                    
                  </a>
                  <a href="https://x.com/RohanSh71756471?t=ebW0ovGu_6T0vj702U_xHQ&s=09">
